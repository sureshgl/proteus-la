...
public class Field_member_nameContextExt extends AbstractBaseExtendedContext{
	...
	*/
	@Override
	public Field_member_nameContext getContext(String str){
		return (Field_member_nameContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).field_member_name());
	}
