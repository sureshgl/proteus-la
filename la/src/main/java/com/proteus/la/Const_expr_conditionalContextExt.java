...
public class Const_expr_conditionalContextExt extends Constant_expressionContextExt{
	...
	*/
	@Override
	public Const_expr_conditionalContext getContext(String str){
		return (Const_expr_conditionalContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).constant_expression());
	}
