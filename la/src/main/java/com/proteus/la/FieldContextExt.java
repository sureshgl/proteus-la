...
public class FieldContextExt extends AbstractBaseExtendedContext {
	...
	public Long getStartIndex() {
		return getLatestContext().field_range().extendedContext.getStartIndex();
	}

	public Long getStopIndex() {
		return getLatestContext().field_range().extendedContext.getStopIndex();
	}

	public Long getSize() {
		return getLatestContext().field_range().extendedContext.getSize();
	}
