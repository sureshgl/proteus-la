...
public class Enum_elementContextExt extends AbstractBaseExtendedContext{
	...
	*/
	@Override
	public Enum_elementContext getContext(String str){
		return (Enum_elementContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).enum_element());
	}
