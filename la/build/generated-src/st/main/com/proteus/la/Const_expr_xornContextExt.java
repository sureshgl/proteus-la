...
public class Const_expr_xornContextExt extends Constant_expressionContextExt{
	...
	*/
	@Override
	public Const_expr_xornContext getLatestContext(){
		return (Const_expr_xornContext)super.getLatestContext();
	}
	...
	*/
	@Override
	public Const_expr_xornContext getContext(String str){
		return (Const_expr_xornContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).constant_expression());
	}
