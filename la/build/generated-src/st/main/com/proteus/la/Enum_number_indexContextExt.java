...
public class Enum_number_indexContextExt extends AbstractBaseExtendedContext{
	...
	*/
	@Override
	public Enum_number_indexContext getContext(String str){
		return (Enum_number_indexContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).enum_number_index());
	}
