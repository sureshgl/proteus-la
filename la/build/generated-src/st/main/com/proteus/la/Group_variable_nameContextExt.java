...
public class Group_variable_nameContextExt extends AbstractBaseExtendedContext{
	...
	*/
	@Override
	public Group_variable_nameContext getContext(String str){
		return (Group_variable_nameContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).group_variable_name());
	}
