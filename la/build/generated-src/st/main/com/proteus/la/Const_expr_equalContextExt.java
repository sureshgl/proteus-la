...
public class Const_expr_equalContextExt extends Constant_expressionContextExt{
	...
	*/
	@Override
	public Const_expr_equalContext getLatestContext(){
		return (Const_expr_equalContext)super.getLatestContext();
	}
	...
	*/
	@Override
	public Const_expr_equalContext getContext(String str){
		return (Const_expr_equalContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).constant_expression());
	}
