...
public class Const_expr_divContextExt extends Constant_expressionContextExt{
	...
	*/
	@Override
	public Const_expr_divContext getContext(String str){
		return (Const_expr_divContext)new LAParserPopulateExtendedContextVisitor().visit(((LAParser)getParser(str)).constant_expression());
	}
